# Comparative Anatomy of Vertebrates: The Pattern Hunters
...
## 🚀 Interactive Learning Modules (Google Colab)

Click the "Open in Colab" badges below to launch the interactive modules. These notebooks include Python widgets to visualize anatomical transitions.

| # | Topic | Key Concepts | Launch |
|:--|:---|:---|:---:|
...
| 7 | **Circulation & Aortic Arches** | Evolution of the heart and the fate of the six aortic arches. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/The-Pattern-Hunter/Comparative_anatomy_of_vertebrates/blob/main/notebooks/07_Circulation_Heart_Aortic_Arches_Interactive.ipynb) |
| 8 | **Excretory System** | Kidney types: From Pronephros to Metanephros. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/The-Pattern-Hunter/Comparative_anatomy_of_vertebrates/blob/main/notebooks/08_Kidney_Succession_Interactive.ipynb) |
| 9 | **Urogenital System** | combines the urinary system (kidneys, ureters, bladder, urethra for waste removal) and the reproductive system (gonads, ducts, external organs for reproduction)  | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/The-Pattern-Hunter/Comparative_anatomy_of_vertebrates/blob/main/notebooks/09_Urinogenital_Ducts_and_Uterine_Types_Interactive.ipynb) |
| 10 | **Nervous System** | Brain evolution: Cephalization and regional specialization. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/The-Pattern-Hunter/Comparative_anatomy_of_vertebrates/blob/main/notebooks/10_Brain_NervousSystem_CranialNerves.ipynb) |
| 11 | **Receptor System** | Comparative anatomy of the eye, ear, and lateral line.  | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/The-Pattern-Hunter/Comparative_anatomy_of_vertebrates/blob/main/notebooks/11_Receptors_Classification_Visual_Auditory.ipynb) |

---

## 🔬 Scientific Foundations
This series explores the three core pillars of Comparative Anatomy:
1. **Homology:** Identifying structures derived from a common ancestor.
2. **Convergence:** How different lineages solve similar environmental challenges.
3. **Phylogeny:** Mapping anatomical complexity onto the tree of life.
